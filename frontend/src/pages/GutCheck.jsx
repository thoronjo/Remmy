    ...
    <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
        ...
        <div>
          <h2 style={{
            ...
            {phase === 'intro' && `${Math.min(6 + (realOptions.length - 2) * 4, 20)}-SECOND GUT`}
            {phase === 'timer' && 'FEEL IT.'}
      ...
      {phase === 'intro' && (
        <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <div className="card" style={{ lineHeight: 1.8, fontSize: '0.9rem', color: 'var(--text-dim)' }}>
            <p>
              You have <strong style={{ color: 'var(--yellow)' }}>{Math.min(6 + (realOptions.length - 2) * 4, 20)} seconds</strong> to sit with your options.
            </p>
      ...
      {phase === 'timer' && (
        <div className="fade-in">
          ...
          <Timer seconds={Math.min(6 + (realOptions.length - 2) * 4, 20)} onEnd={handleTimerEnd} />
        </div>
      )}
